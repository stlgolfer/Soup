...
import xyz.amtstl.soup.output.CompilerWriter;
...
public class LogicController {
	...
	public static void soupAdd(int i, String cache) throws NumberFormatException, SoupVariableException, SoupSyntaxException {
		...
		// add to compiler instructions
		String commandout = "";
		for (int e = 0; e < ns.size(); e++) {
			if (e != ns.size() - 1) {
				commandout += ns.get(e) + "+";
			}
			else {
		...
		CompilerWriter.getOutputs().add(commandout);
	}
	...
	public static void soupPow(int i, String cache) throws NumberFormatException, SoupVariableException, SoupSyntaxException {
		...
		// add to compiler instructions
		String commandout = "Math.pow(" + ns.get(0) + ", " + ns.get(1) + ")";
		CompilerWriter.getOutputs().add(commandout);
	}
